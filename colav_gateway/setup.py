...
setup(
    ...
    data_files=[
        ...
        (
            f"lib/python3.10/site-packages/{package_name}/scripts",
            glob("scripts/*.py"),
        ),  # adding scripts manually so theres an explicity namespace
        (
            f"lib/python3.10/site-packages/{package_name}/utils",
            glob("utils/*.py"),
        ),  # adding utils manually so there is an explicit namespace in site-packages
    ],
    install_requires=[
        "setuptools",
        "protobuf",
